...
public interface TranscodingController {
	...
	void transcode(TranscodingProfile profile, String programEpisodeName, String seriesTitle, String programTitle, File inputFile, File outputFile) throws Exception;
