...
public class FastStartVodTranscoderImpl extends AbstractTranscoderImpl implements Transcoder {
  ...
  public void transcode(File workingDirectory, GenericTranscoderConfigurationItem genericConfig,
    ...
    FastStartTranscoderConfigurationItem config =
        (FastStartTranscoderConfigurationItem) genericConfig;
    ...
    try {
      ...
      throw new Exception("FastStart process interrupted by another thread", e);
    } catch (ExecutionException ee) {
      throw new Exception("Something went wrong parsing FastStart output", ee);
      ...
      throw new Exception("Something went wrong parsing FastStart output", re);
    } finally {
      if (process != null) {
        process.destroy();
      }
