...
public class ClipLocatorImpl implements ClipLocator {
   ...
   * 
   * @see
   * net.urlgrey.mythpodcaster.transcode.ClipLocator#locateThumbnailForOriginalClip(java.lang.String
   * )
   */
  @Override
  public File locateThumbnailForOriginalClip(String filename) {
    ...
    if (clipFile != null) {
      final File clipThumbnailFile =
          new File(clipFile.getParentFile(), clipFile.getName() + PNG_EXTENSION);
