...
public class AddSubscriptionHandler implements ClickHandler {
  ...
  public AddSubscriptionHandler(RecordingsPanel parent, String transcodingProfile, String seriesId,
      String seriesTitle) {
    this.parent = parent;
  ...
  public void onClick(ClickEvent arg0) {
                ...
                public void onSuccess(List<String[]> recordings) {
                  ...
                  for (String[] recording : recordings) {
                    ...
                    final String recordingTitle =
                        (recording[1] != null && recording[1].trim().length() > 0) ? recording[1]
                            : seriesTitle;
        ...
        try {
          ...
          switch (scopeListBox.getSelectedIndex()) {
            case SCOPE_INDEX_MOST_RECENT:
              ...
              item.setNumberOfMostRecentToKeep(Integer.parseInt(mostRecentListBox
                  .getValue(mostRecentListBox.getSelectedIndex())));
              break;
            case SCOPE_INDEX_SPECIFIC_RECORDINGS:
    ...
    if (profileListBox == null) {
      ...
      UIControllerServiceAsync service =
          (UIControllerServiceAsync) GWT.create(UIControllerService.class);
      try {
        service.findAvailableTranscodingProfilesForSeries(seriesId,
