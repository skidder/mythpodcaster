...
public interface UIControllerServiceAsync {
  ...
  void findSubscriptionsForSeries(String seriesId,
  ...
  void addSubscription(FeedSubscriptionItemDTO item, AsyncCallback<Boolean> asyncCallback);
  ...
  void listRecordingsForSeries(String seriesId, AsyncCallback<List<String[]>> asyncCallback);

  void retrieveSubscriptionDetails(String seriesId, String transcodingProfile,
