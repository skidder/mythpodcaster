...
public interface UIControllerService extends RemoteService {
  ...
  List<String[]> findAvailableTranscodingProfilesForSeries(String seriesId);
  ...
  FeedSubscriptionItemDTO retrieveSubscriptionDetails(String seriesId, String transcodingProfile);
