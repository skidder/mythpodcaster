...
public class StatusPanel extends Composite {
  ...
  private DateTimeFormat dateFormatter = DateTimeFormat
      ...
      public void onSuccess(StatusDTO status) {
        if ("IDLE".equalsIgnoreCase(status.getMode())) {
          ...
          if (status.getCurrentTranscodeStart() != null) {
            ...
            currentTranscodeStartValueLabel.setText(dateFormatter.format(status
                .getCurrentTranscodeStart()));
            ...
            transcodingProgramEpisodeNameValueLabel.setText(status
