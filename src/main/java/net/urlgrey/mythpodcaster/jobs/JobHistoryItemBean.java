...
public class JobHistoryItemBean {
  ...
  public int hashCode() {
    ...
    int result = 1;
    result =
        prime * result + ((transcodingProfileName == null) ? 0 : transcodingProfileName.hashCode());
    result =
        prime * result + ((transcodingProgramKey == null) ? 0 : transcodingProgramKey.hashCode());
    return result;
  }
  ...
  public boolean equals(Object obj) {
    ...
    if (transcodingProgramKey == null) {
      if (other.transcodingProgramKey != null)
        return false;
    } else if (!transcodingProgramKey.equals(other.transcodingProgramKey))
      return false;
    return true;
  }
  ...
  public String toString() {
    return "JobHistoryItemBean [transcodingProfileName=" + transcodingProfileName
        + ", transcodingProgramKey=" + transcodingProgramKey + ", transcodingProgramName="
        + transcodingProgramName + ", transcodingSeriesTitle=" + transcodingSeriesTitle
